...
<body>
  ...
  <div class="landing">
    ...
    <div class="landing-info">
      ...
      <!-- LANDING INFO TITLE -->
      <h1 class="landing-info-title">GOOD AH</h1>
      <!-- /LANDING INFO TITLE -->
      ...
      <div class="form-box login-register-form-element">
        ...
        <form class="form" id="SignUp" method="post">
          ...
          <div class="form-row">
            ...
            <div class="form-item col-6">
              ...
              <div class="form-input">
                ...
                <input type="text" id="register-username" name="register_Fname">
              </div>
              <!-- /FORM INPUT -->
          ...
          <!-- /FORM ROW -->
            ...
            <div class="form-item col-6">
              ...
              <div class="form-input">
                ...
                <input type="text" id="register-username" name="register_Lname">
              </div>
              <!-- /FORM INPUT -->
            </div>
            <!-- /FORM ITEM -->
          ...
          <div class="form-row">
            ...
            <div class="form-item">
              <!-- BUTTON -->
              <button type="submit" class="button medium primary mb-2 ">Register Now!</button>
              <!-- /BUTTON -->
            </div>
            <!-- /FORM ITEM -->
          </div>
